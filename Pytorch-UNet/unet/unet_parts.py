...
class eca_layer(nn.Module):
    ...
    def __init__(self, channel, k_size=None):
        ...
        if k_size is None:
            k_size = self.eca_kernel_size(channel)
        self.conv = nn.Conv1d(1, 1, kernel_size=k_size, padding=(k_size - 1) // 2, bias=False) 
        self.sigmoid = nn.Sigmoid()

    def eca_kernel_size(self, C, gamma=2, beta=1):
        """Compute 1d conv kernel size in eca block.
        Input:
            C: INT, input tensor channel
        Return:
            k_size: INT, kernel size of 1d conv
        """
